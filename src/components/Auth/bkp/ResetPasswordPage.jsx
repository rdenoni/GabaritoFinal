            ...
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md mx-auto">
                ...
                <motion.form onSubmit={handleResetPassword} variants={shakeVariants} animate={shake ? "shake" : ""} onAnimationComplete={() => setShake(false)}>
                    <div className="space-y-6 bg-gray-800 p-8 rounded-xl shadow-lg">
                        ...
                        <button type="submit" disabled={loading} className="w-full py-3 px-6 bg-[--color-accent] text-black font-bold rounded-lg hover:bg-[--color-accent-hover] flex items-center justify-center gap-2">
